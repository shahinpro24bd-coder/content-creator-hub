...
(function localSiteControls() {
    var translations = {
        ...
        'Dr. Narayan Chowdhury (Nixon)': 'ডাঃ নারায়ণ চৌধুরী (নিক্সন)',
    ...
    var phraseTranslations = [
        ['Urologist & Surgeon', 'ইউরোলজি বিশেষজ্ঞ ও সার্জন'], ['Urology', 'ইউরোলজি'],
        ...
        ['Contact', 'যোগাযোগ'], ['Hospital', 'হাসপাতাল'], ['Rangpur', 'রংপুর']
    ];
